...
public static class AlarmDefinitionCatalog
{
    ...
    private static IReadOnlyList<AlarmDefinition> BuildDefinitions()
    {
        var definitions = new List<AlarmDefinition>
        {
            ...
            CreateBit(
                "alarm.output_rotate_timeout_0",
                PlcTagCatalog.Alarms.OutputRotateTimeout0,
                AlarmType.Error,
                AlarmSeverity.Warning,
                "Lỗi TimeOut Xilanh xoay 0 Cụm đầu ra",
                "Xilanh xoay 0 cụm đầu ra quá thời gian.",
                "Kiểm tra xilanh xoay 0 cụm đầu ra."),
            CreateBit(
                "alarm.output_rotate_timeout_90",
                PlcTagCatalog.Alarms.OutputRotateTimeout90,
                AlarmType.Error,
                AlarmSeverity.Warning,
                "Lỗi TimeOut Xilanh xoay 90 Cụm đầu ra",
                "Xilanh xoay 90 cụm đầu ra quá thời gian.",
                "Kiểm tra xilanh xoay 90 cụm đầu ra."),
            CreateBit(
                "alarm.shift_left_timeout",
                PlcTagCatalog.Alarms.ShiftLeftTimeout,
                AlarmType.Error,
                AlarmSeverity.Warning,
                "Lỗi Timeout Xilanh chuyển phôi sang trái",
                "Xilanh chuyển phôi sang trái quá thời gian.",
                "Kiểm tra xilanh chuyển phôi sang trái."),
            CreateBit(
                "alarm.shift_right_timeout",
                PlcTagCatalog.Alarms.ShiftRightTimeout,
                AlarmType.Error,
                AlarmSeverity.Warning,
                "Lỗi Timeout Xilanh chuyển phôi sang phải",
                "Xilanh chuyển phôi sang phải quá thời gian.",
                "Kiểm tra xilanh chuyển phôi sang phải."),
            CreateBit(
                "alarm.shift_in_timeout",
                PlcTagCatalog.Alarms.ShiftInTimeout,
                AlarmType.Error,
                AlarmSeverity.Warning,
                "Lỗi Timeout Xilanh chuyển phôi ở trong",
                "Xilanh chuyển phôi ở trong quá thời gian.",
                "Kiểm tra xilanh chuyển phôi ở trong."),
            CreateBit(
                "alarm.shift_out_timeout",
                PlcTagCatalog.Alarms.ShiftOutTimeout,
                AlarmType.Error,
                AlarmSeverity.Warning,
                "Lỗi Timeout Xilanh chuyển phôi ở ngoài",
                "Xilanh chuyển phôi ở ngoài quá thời gian.",
                "Kiểm tra xilanh chuyển phôi ở ngoài."),
            CreateBit(
                "alarm.product_clamp_timeout",
                PlcTagCatalog.Alarms.ProductClampTimeout,
                AlarmType.Error,
                AlarmSeverity.Warning,
                "Lỗi Timeout Kẹp phôi thành phẩm",
                "Xilanh kẹp phôi thành phẩm quá thời gian.",
                "Kiểm tra xilanh kẹp phôi thành phẩm."),
            CreateBit(
                "alarm.product_unclamp_timeout",
                PlcTagCatalog.Alarms.ProductUnclampTimeout,
                AlarmType.Error,
                AlarmSeverity.Warning,
                "Lỗi Timeout Mở Kẹp phôi thành phẩm",
                "Xilanh mở kẹp phôi thành phẩm quá thời gian.",
                "Kiểm tra xilanh mở kẹp phôi thành phẩm."),
            CreateBit(
                "alarm.output_magnet_in_timeout",
                PlcTagCatalog.Alarms.OutputMagnetInTimeout,
                AlarmType.Error,
                AlarmSeverity.Warning,
                "Lỗi Timout Xilanh cụm Nam châm Output ở trong",
                "Xilanh nam châm output ở trong quá thời gian.",
                "Kiểm tra xilanh nam châm output ở trong."),
            CreateBit(
                "alarm.output_magnet_out_timeout",
                PlcTagCatalog.Alarms.OutputMagnetOutTimeout,
                AlarmType.Error,
                AlarmSeverity.Warning,
                "Lỗi Timout Xilanh cụm Nam châm Output ở ngoài",
                "Xilanh nam châm output ở ngoài quá thời gian.",
                "Kiểm tra xilanh nam châm output ở ngoài."),
        };
